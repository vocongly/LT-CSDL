	 ...
	 public partial class AddAccount : Form
	 {
		  ...
		  public void DisplayAccount(string accountName)
		  {
				...
				while (reader1.Read())
				{
					 ...
					 txtPassword.Text = reader1["Password"].ToString();
		  ...
		  private void btnUpdateAccount_Click(object sender, EventArgs e)
		  {
				...
				sqlCommand.CommandText = "Update Account set [FullName]=N'"+txtHoTen.Text+"',[Password]=N'"+txtPassword.Text+"',[Email]=N'"+txtEmail.Text+
				...
				foreach (var item in clbVaitro.CheckedItems)
				{
					 ...
					 sqlCommand.CommandText = "UPDATE RoleAccount SET [Notes] = N'"+
						  txtNote.Text+"' where [AccountName] = N'" + txtAccountName.Text + "'";
					 numOfRowEffected += sqlCommand.ExecuteNonQuery();
				}
				sqlConnection.Close();
